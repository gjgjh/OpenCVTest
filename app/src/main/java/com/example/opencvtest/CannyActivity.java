...
public class CannyActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    Mat image,imageGrey,imageCanny;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(CannyActivity.this,new String[]{Manifest.permission.CAMERA},1);
        }else {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        imageGrey=new Mat(height,width, CvType.CV_8UC1);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Imgproc.cvtColor(image,imageGrey,Imgproc.COLOR_RGBA2GRAY);
        Imgproc.Canny(imageGrey,imageCanny,50,150);
